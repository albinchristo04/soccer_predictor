  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-extrabold text-gray-800 dark:text-white sm:text-6xl md:text-7xl">Match Prediction</h1>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {/* Prediction Form */}
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-2xl mb-8 border-2 border-gray-200 dark:border-gray-700">
          {mode === 'head-to-head' ? (
