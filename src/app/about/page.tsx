  ...
  return (
    ...
    <div className="border-b border-gray-300">
      ...
      <button
        ...
        className="w-full py-4 text-left flex justify-between items-center focus:outline-none hover:bg-gray-50 transition-colors rounded-lg px-2"
      ...
      >
        ...
        <span className={`transform transition-transform duration-300 text-2xl text-green-600 ${isOpen ? 'rotate-45' : ''}`}>
      ...
      <div
        ...
        <div className="py-4 text-gray-700 px-2">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-extrabold text-gray-800 sm:text-6xl md:text-7xl">About Soccer Stats Predictor</h1>
