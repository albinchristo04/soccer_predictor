    ...
    <div className="max-w-6xl mx-auto text-center py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <Link href="/upcoming" className="block group">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-green-500/50 dark:hover:shadow-green-400/50 transition-all duration-300 transform hover:-translate-y-2 cursor-pointer border-4 border-transparent hover:border-green-500 dark:hover:border-green-400 h-full flex flex-col">
        ...
        <Link href="/predict?mode=cross-league" className="block group">
          <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-green-500/50 dark:hover:shadow-green-400/50 transition-all duration-300 transform hover:-translate-y-2 cursor-pointer border-4 border-transparent hover:border-green-500 dark:hover:border-green-400 h-full flex-col">
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 p-6 rounded-lg shadow-inner border-2 border-yellow-300 dark:border-yellow-600">
        <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-200">⚠️ Disclaimer</h2>
