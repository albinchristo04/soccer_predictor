...
export const Footer = () => {
  return (
    <footer className="bg-white border-t-4 border-green-500 py-6 mt-8 shadow-lg">
      <div className="container mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 mb-2">
            Data source: <a href="https://fbref.com/en/" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline font-semibold">FBRef</a> | Terms of Service Apply
          </p>
