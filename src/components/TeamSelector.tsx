...
export const TeamSelector = ({ type, formData, setFormData }: TeamSelectorProps) => {
  ...
  if (type === 'head-to-head') {
    return (
      <div className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-primary text-center">League</label>
          <div className="relative max-w-md mx-auto">
            <select
              value={formData.league}
              onChange={(e) => setFormData({ ...formData, league: e.target.value, home_team: '', away_team: '' })}
              className="appearance-none w-full bg-card border-2 border-brand-500 text-primary text-lg rounded-lg py-3 px-5 pr-10 focus:outline-none focus:border-brand-600 focus:ring-2 focus:ring-brand-500 transition duration-300 ease-in-out shadow-card"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium mb-2 text-primary">Home Team</label>
            <div className="relative">
              <select
                value={formData.home_team}
                onChange={(e) => setFormData({ ...formData, home_team: e.target.value })}
                className="appearance-none w-full bg-card border-2 border-primary text-primary text-lg rounded-lg py-3 px-5 pr-10 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500 transition duration-300 ease-in-out shadow-card"
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-primary">Away Team</label>
            <div className="relative">
              <select
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium mb-2 text-primary">Home Team League</label>
          <div className="relative">
            <select
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-primary">Away Team League</label>
          <div className="relative">
            <select
