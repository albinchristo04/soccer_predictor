...
export const TeamSelector = ({ type, formData, setFormData }: TeamSelectorProps) => {
  ...
  if (type === 'head-to-head') {
    return (
      <div className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-gray-700 text-center">League</label>
          <div className="relative max-w-md mx-auto">
            <select
              value={formData.league}
              onChange={(e) => setFormData({ ...formData, league: e.target.value, home_team: '', away_team: '' })}
              className="appearance-none w-full bg-white border-2 border-green-500 text-gray-800 text-lg rounded-lg py-3 px-5 pr-10 focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-500 transition duration-300 ease-in-out shadow-sm"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-700">Home Team</label>
            <div className="relative">
              <select
                value={formData.home_team}
                onChange={(e) => setFormData({ ...formData, home_team: e.target.value })}
                className="appearance-none w-full bg-white border-2 border-gray-300 text-gray-800 text-lg rounded-lg py-3 px-5 pr-10 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500 transition duration-300 ease-in-out shadow-sm"
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-700">Away Team</label>
            <div className="relative">
              <select
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium mb-2 text-gray-700">Home Team League</label>
          <div className="relative">
            <select
        ...
        <div>
          <label className="block text-sm font-medium mb-2 text-gray-700">Away Team League</label>
          <div className="relative">
            <select
